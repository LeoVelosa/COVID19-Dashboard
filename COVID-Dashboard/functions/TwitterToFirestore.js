...
exports.AvailabilityTweets = functions.runWith({timeoutSeconds: 539}).pubsub.schedule('0 0 * * *').onRun( async(context) => {
...
exports.EligibilityTweets = functions.runWith({timeoutSeconds: 539}).pubsub.schedule('0 0 * * *').onRun( async(context) => {
