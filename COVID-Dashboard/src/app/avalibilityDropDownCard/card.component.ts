...
/* This file interacts with every other file in avalibilityDropDownCard. Aside from that, it uses functions from FirebaseTweetsToHTML.js in the file COVID-Dashboard/src/javaStuff  */
